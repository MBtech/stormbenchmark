...
public class HDFSFileReaderLimited implements Serializable {

  private static final long serialVersionUID = -7012334600647557269L;
  ...
  public HDFSFileReaderLimited(String file) {
    this.file = file;
    if (this.file != null) {
          try {
